...
\usepackage[top=1in, left=1in, bottom=1in, right=1in]{geometry}        % Sets margins
\usepackage{hyperref}
\usepackage{xfrac}
...
\framebox{\parbox{\dimexpr0.7\linewidth}{
Presentation calendars (select a date to view presenter details):

\href{https://calendar.google.com/calendar/embed?src=uw.edu_bhrekoo2mibn07njcsqddn4bhk@group.calendar.google.com&ctz=America/Los_Angeles}{ASTR 150 AE calendar}

\href{https://calendar.google.com/calendar/embed?src=uw.edu_covgl483mi6ad1olrm0v2t6fa0@group.calendar.google.com&ctz=America/Los_Angeles}{ASTR 150 AJ calendar}
}}
